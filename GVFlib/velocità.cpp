...
ofstream XFile("Xdata.txt"), outFileXY("merged.txt"), XFileT("test.txt"), velXY("velXY.txt"); // file com dados para treino
...
velXY.open("velXY.txt", std::ios_base::app);
}
else {
XFileT.open("test.txt", std::ios_base::app);
}	
	while(getline(ifile,line)){
	//curr = stoi(line);
	//if(n % 2 == 0) {
	prec.push_back(stoi(line));
	//}
	
			if(sta < 3){
			if(n == size - 1) {
			XFile << line << endl;
			velXY << (stoi(line) - prec[n-1]) << endl;
			} 
			else {
			XFile << line << ", ";
			if(n>=1)
			velXY << (stoi(line) - prec[n-1]) << ",";
			else velXY << 0 << ",";
			}
			}
			else{
...
if(state == 3){
dirFaces = "./";
dirFaces =  dirFaces + "Templates/braccia1xRic/";
}
if(state == 3){
dirFaces = "./";
dirFaces =  dirFaces + "Templates/braccia2xRic/";
}
if(state == 3){
dirFaces = "./";
...
if(state == 4){
dirFaces = "./";
dirFaces =  dirFaces + "Templates/maneboca1xRic/";
}
if(state == 4){
dirFaces = "./";
dirFaces =  dirFaces + "Templates/maneboca2xRic/";
}
if(state == 4){
dirFaces = "./";
...
if(state == 5){
dirFaces = "./";
dirFaces =  dirFaces + "Templates/puntare1xRic/";
}
if(state == 5){
dirFaces = "./";
dirFaces =  dirFaces + "Templates/puntare2xRic/";
}
if(state == 5){
dirFaces = "./";
...
if(state == 3){
dirFaces = "./";
dirFaces =  dirFaces + "Templates/braccia1xCl/";
}
if(state == 3){
dirFaces = "./";
dirFaces =  dirFaces + "Templates/braccia2xCl/";
}
if(state == 3){
dirFaces = "./";
dirFaces =  dirFaces + "Templates/braccia45d1xCl/";
}
if(state == 3){
dirFaces = "./";
dirFaces =  dirFaces + "Templates/braccia45d2xCl/";
}
if(state == 3){
dirFaces = "./";
dirFaces =  dirFaces + "Templates/braccia45s1xCl/";
}
if(state == 3){
dirFaces = "./";
dirFaces =  dirFaces + "Templates/braccia45s2xCl/";
}
if(state == 4){
dirFaces = "./";
dirFaces =  dirFaces + "Templates/maneboca1xCl/";
}
if(state == 4){
dirFaces = "./";
dirFaces =  dirFaces + "Templates/maneboca2xCl/";
}
if(state == 4){
dirFaces = "./";
dirFaces =  dirFaces + "Templates/maneboca45d1xCl/";
}
if(state == 4){
dirFaces = "./";
dirFaces =  dirFaces + "Templates/maneboca45d2xCl/";
}
if(state == 4){
dirFaces = "./";
dirFaces =  dirFaces + "Templates/maneboca45s1xCl/";
}
if(state == 4){
dirFaces = "./";
dirFaces =  dirFaces + "Templates/maneboca45s2xCl/";
}
if(state == 5){
dirFaces = "./";
dirFaces =  dirFaces + "Templates/puntare1xCl/";
}
if(state == 5){
dirFaces = "./";
dirFaces =  dirFaces + "Templates/puntare2xCl/";
}
if(state == 5){
dirFaces = "./";
dirFaces =  dirFaces + "Templates/puntare45d1xCl/";
}
if(state == 5){
dirFaces = "./";
dirFaces =  dirFaces + "Templates/puntare45d2xCl/";
}
if(state == 5){
dirFaces = "./";
dirFaces =  dirFaces + "Templates/puntare45s1xCl/";
}
if(state == xxxxxxxxx){
dirFaces = "./";
dirFaces =  dirFaces + "Templates/puntare45s2xCl/";
}
} // SWITCH
