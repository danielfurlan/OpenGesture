/**
 * 
 * by Daniel Frederico MASSON FURLAN. The library has been created and is maintained by Daniel Frederico MASSON FURLAN
 *
 * Copyright (C) 2019 Daniel Frederico MASSON FURLAN
 *
...
float resPe();
float kapa();
void Graph3D(float x, float y, float z); 
...
// The following functions are used only for creating synthetic data. May be
// ignored.
...
// END FUNCTIONS FOR SYNTHETIC DATA
...
//cout << "Primo elemento del file : " << INI[0] << "\n";
	for(int pt = 0 ; pt < numPunti ; pt++){	
		...
		*/		
		...
		// ----------------------------------
		//vector.push_back(punto[2]); // UNCOMMENT IF 3D keypoints!!!!
		// ----------------------------------
...
///////////////////////////////////////////////
// -------------CHANGE THE DIRECTORY PAHT HERE:
...
int gr = 0;
    ...
    cout << "Enter the name of the gesture : \n";
	cin >> gesto;
...
*/
	...
	*/
    ...
    cout << "Gesture finished. What do you want to do?\n\n'r' for new gesture\n'e' to exit 'recording' mode\n";
	cin >> c;
	gr = 1;	
	Total = 0;
	}
...
// ---------------- AUTOMATIC RECORDING OF MULTIPLE GESTURES
void registrare2(){
	xGraph = 0;
	progP = 1;
	progN = 1;
...
int gr = 0;
    ...
    cout << "Enter the number of examples for the dataset (bigger than 10) : \n" << endl;
...
void follower(){
	...
	*/	
    ...
    cout << "Enter 'r' to begin recording the gesture variation : \n";
	cin >> c;
int gr = 0;
	if(c == 'r'){
	while(c=='r'){
	...
	if(gr == 1){
		...
		cin >> gesto;
		cout << "Inserisce R per comminciare a registrare\n";
        cout << "Enter 'r' to begin recording\n";
		cin >> c;
	}	
	for(int og = 0 ; og < numPunti ; og++) 
	gvf[og]->startGesture();
...
int i,e;
    ...
    cout << "English: " << endl
	cout << "Choose the option: \n 1) Record\n 2) Follower\n 3) Exit\n 4) Remove gesture template\n 5) See recorded gestures\n 6) Automatic recording\n 7) Create synthetic data\n";
	cin >> i;
	cout << "\nHai scelto l'opzione " << i << "\n";
    cout << "\nYou chose the option " << i << "\n";
...
case 1 :
    ...
    cout << "\n...setting the state to 'recordin'...\n ";
	mode = "registrare";
	registrare();
	break;
case 2 :
	cout << "\n...setting lo stato per follower...\n ";
	cout << "\n...setting the state to 'follower'...\n ";
    follower();
	break;	
case 3 :
	exit(0);
...
case 4 : {
    ...
    cout << "Choose the gesture to be removed : \n";
	for(int w = 0; w <= Temp; w++)
...
case 6 : {
    ...
    cout << "\n...setting the state to automatic registration...\n ";
	registrare2();
	break;
}
case 7 : {
...
cout << "Enter the points you want to analyse and then \"f\" to finish\n";
...
cout << "{0,  \"Nose\"}\n{1,  \"Neck\"}\n{2,  \"RShoulder\"}\n{3,  \"RElbow\"}\n{4,  \"RWrist\"}\n{5,  \"LShoulder\"}\n{6,  \"LElbow\"}\n{7,  \"LWrist\"}\n{8,  \"MidHip\"}\n{9,  \"RHip\"}\n{11, \"RAnkle\"}\n{12, \"LHip\"}\n{13, \"LKnee\"}\n{14, \"LAnkle\"}\n{15, \"REye\"}\n{16, \"LEye\"}\n{17, \"REar\"}\n{18, \"LEar\"}\n";
    ...
    cout << "Dimension of vector 'punti' : " << numPunti << "\n";
